...
fun allKvizes(): List<Kviz>{
    return listOf(
            ...
            Kviz("DM Kviz 2", "DM", GregorianCalendar(2020,8,29).time, GregorianCalendar(2020,8,29).time, GregorianCalendar(2020,8,29).time, 90, "DM Grupa 1", 7.8f),
            ...
            Kviz("TP Kviz 2", "TP", GregorianCalendar(2021,1,15).time, GregorianCalendar(2021,1,15).time,  GregorianCalendar(2021,1,15).time, 5, "TP Grupa 1", 1.5f),
