...
fun allKvizes(): List<Kviz>{
    return listOf(
            ...
            Kviz("DM Kviz 1", "DM", GregorianCalendar(2020,9,20).time, GregorianCalendar(2020,9,20).time, GregorianCalendar(2020,9,20).time, 90, "DM Grupa 1", 5f),
            ...
            Kviz("DM Kviz 1", "DM", GregorianCalendar(2020,8,29).time, GregorianCalendar(2020,8,29).time, GregorianCalendar(2020,8,29).time, 90, "DM Grupa 1", 7.8f),
            ...
            Kviz("TP Kviz 1", "TP", GregorianCalendar(2021,1,15).time, GregorianCalendar(2021,1,15).time,  GregorianCalendar(2021,1,15).time, 5, "TP Grupa 1", 1.5f),
            Kviz("RPR Kviz 1", "RPR", GregorianCalendar(2021,2,15).time, GregorianCalendar(2021,11,15).time, GregorianCalendar(1970,0,1).time, 35, "RPR Grupa 1", null),
            ...
            Kviz("OIS Kviz 2", "OIS", GregorianCalendar(2021,8,16).time, GregorianCalendar(2021,8,16).time, GregorianCalendar(1970,0,1).time, 85, "OIS Grupa 2", null),
